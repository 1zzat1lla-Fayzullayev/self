...
function Ecosystem() {
	return (
		<>
			<Wrapper>
				<div className='flex flex-col md:flex-row justify-center items-center gap-[50px] mt-[200px] mx-[20px] md:mx-0'>
					<div className='relative'>
						<img src={manifestobg} alt='404' className='w-[500px] ' />
						<img
							src={ecosystem}
							alt='404'
					...
					<div className='md:w-[50%] flex flex-col gap-[30px]'>
