...
const FirstSlider = () => {
	return (
		<>
			<h2 className='text-white font-semibold text-center text-[35px] mt-[100px]'>Trusted by the best</h2>
					...
					{firstslider.concat(firstslider).map((slide, index) => (
						...
						>
							<img
								src={slide.img}
								alt={slide.title}
								className='h-[100px] object-cover transition-transform duration-1000 hover:translate-z-[20px]'
							/>
							<p>{slide.title}</p>
						</div>
					))}
